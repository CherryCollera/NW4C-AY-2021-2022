...
public class SchoolListAdapter extends FirestoreRecyclerAdapter<SchoolInfo, SchoolListAdapter.SchoolListHolder> {

    private OnItemClickListener listener;

    public SchoolListAdapter(@NonNull @NotNull FirestoreRecyclerOptions<SchoolInfo> options) {
        super(options);
    }
    ...
    public SchoolListHolder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.school_list_cardview, parent, false);
