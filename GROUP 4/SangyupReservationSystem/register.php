                ...
                <div class="row">
                  ...
                  <div class="col-md-12">
                      ...
                      <form action="manage-insert.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                        <label for="image">Provide ID in .png format </label>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-8">
                    <div class="menus d-flex ftco-animate" style="background: white;">
                      <div class="row" style="width: 100%">
                  <div class="col-md-12">
                      <form id="frmregisterrestaurant" action="manage-insert.php" method="POST" enctype="multipart/form-data">
                        <div class="form-group">
                 ...
                 <!--        <div class="form-group">
                        ...
                        <div class="form-group">
                          <input id="lat" type="text" name="lat" class="form-control" required="" placeholder="Latitude" disabled="">
                        </div>
                        <div class="form-group">
                          <input id="long" type="text" name="long" class="form-control" required="" placeholder="Logitude" disabled="">
                        </div>
                        <div class="form-group">
                        ...
                        <label for="image">Logo<input type="file" name="image" class="form-control" required="" accept="image/*"></label>
                        </div>
                        <div class="form-group">
                       <!-- <p>Please send a copy of Business Permit at systemsamgyup2021@gmail.com</p>-->
                        </div>
                        <div class="form-group">
                          <input type="submit" value="Register" name="regasres" class="btn btn-primary py-3 px-5">
                          <button type="button" class="btn btn-primary py-3 px-5" data-toggle="modal" data-target="#staticBackdrop">Pick Latitude and longitude</button>
                        </div>
                      </form>
                      <p class="text-center">For Login <a href="login.php">Click Here</a> </p>
...
// }, 
    function initMap() {
      const myLatlng = { lat: 14.678554, lng: 120.539479};
      ...
      map.addListener("click", (mapsMouseEvent) => {
        ...
        var latlong2 =  JSON.parse(latlong);

        $("#lat").val(latlong2.lat);
        $("#long").val(latlong2.lng);
        $("#staticBackdrop").modal('hide');
        $('#frmregisterrestaurant').attr('action', 'manage-insert.php?lat='+latlong2.lat+'&long='+latlong2.lng);
