...
<script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jquery/1.8.3/jquery.min.js"></script>
  <body>
    ...
    <form action="bookd.php" method="POST">
        ...
        <div class="col-md-8 dish-menu">
            ...
            <div class="tab-content py-5" id="v-pills-tabContent">
                ...
                <div class="row">
                  <div class="col-lg-12">
                    <?php 
                      include 'dbCon.php';
                      $con = connect();
                      $sql = "SELECT * FROM `menu_item` WHERE res_id = '$res_id' AND food_type = 'Fast Food' or food_type = 'Raw Meat';";
                    ...
                    <div class="menus d-flex ftco-animate">
                      ...
                      <div class="text d-flex">
                        ...
                        <div class="one-forth" style="text-align: center;">
                          <input type="number" name="qty[]" min="1" value ="1" style="width: 100%;margin-left: 23px;margin-top: 18px;">
                        </div>
                      </div>
                    </div>
                    <?php } ?>
              ...
              <div class="tab-pane fade" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab">
                <div class="row">
                  <div class="col-lg-12">
                    <?php 
                      $sql2 = "SELECT * FROM `menu_item` WHERE res_id = '$res_id' AND food_type = 'Add On';";
          ...
          <div class="col-md-4">
            ...
            <div class="d-flex ftco-animate">
              <div class="col-md-12 flex-column">
                <div class="row d-block flex-row">
                  ...
                  <div class="col mb-2 d-flex py-4 border" style="background: white;">
                    <div class="align-self-center">
                      <p class="mb-0"><span>Contact Number :</span> <a href=""><?php echo $reservation_phone; ?></a></p>
                    </div>
                  </div>
                  <div class="col mb-2 d-flex py-4 border" style="background: white;">
                    <div class="align-self-center">
                      <p class="mb-0"><span>Delivery Date :</span> <a href=""><?php echo $reservation_date; ?></a></p>
                    </div>
                  </div>
                  <div class="col mb-2 d-flex py-4 border" style="background: white;">
                    <div class="align-self-center">
                      <p class="mb-0"><span>Delivery Time :</span> <a href=""><?php echo $reservation_time; ?></a></p>
                    </div>
                  </div>
            ...
            <div class="col-lg-12" style="text-align: center;">
                ...
                <input type="submit" value="Confirm" name="ccod" class="btn btn-primary py-3 px-5" ></p>
