          	...
          	<div class="col-md-6 pr-md-5 flex-column">
	            <div class="row d-block flex-row">
	              <h2 class="h4 mb-4">Menu Item Information</h2>
					...
					<div class="col mb-3 d-flex py-4 border" style="background: white;">
		                <div class="align-self-center">
		                  	<p class="mb-0"><span> Please pay ₱200 for reservation fee in your appointment page. If not your appointment will be declined. 
								  You have 30 minutes after the appointment time and date if you didn't attend the reservation fee will not be refunded.</span></p>
		                </div>
	              	</div>
	              	<div class="col mb-3 d-flex py-4 border" style="background: white;">
		                <div class="align-self-center">
