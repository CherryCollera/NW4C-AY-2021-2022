										...
										<div class="row">
											<div class="col-sm-6">
												<div class="form-group">
													...
													<textarea class="form-control" name="madeby" id="textareaDefault" value="<?php echo $_SESSION['name']?>"></textarea>
												</div>
											</div>
											<div class="col-sm-3">
												<div class="form-group">
													...
													<select data-plugin-selectTwo class="form-control populate" name="measurement" required="">
