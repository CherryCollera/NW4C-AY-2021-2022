                ...
                if (isset($_FILES['image'])) {
                 // files handle
                    ...
                    if ($extension =="jpg" || $extension =="png" || $extension =="jpeg"){
                        ...
                        $iquery="INSERT INTO `menu_item`( `res_id`, `item_name`, `madeby`, `food_type`,`stocks`,`measurement`, `price`, `image`) 
                            VALUES ('$res_id','$itemname','$madeby','$food_type','$stocks','$measurement','$price','$file_name');";
                        if ($con->query($iquery) === TRUE) {
