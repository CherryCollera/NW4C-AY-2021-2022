...
?>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
	  ...
	  <form name ="editform" id ="editform" action="menu-addstock-ajax.php" method="post" enctype="multipart/form-data">
      ...
      <div class="modal-footer">
								...
								<table class="table table-bordered table-striped mb-none" id="datatable-tabletools" data-swf-path="assets/vendor/jquery-datatables/extras/TableTools/swf/copy_csv_xls_pdf.swf">
									...
									<tbody>
										...
										<tr class="gradeX">
											...
											<td id ="soldtd<?php echo $r['id'];?>"><?php echo $r['sold_product']; ?></td>
											<input type="text"id ="sold<?php echo $r['id'];?>" value ="<?php echo $r['sold_product'];?>" hidden>
											<td id ="totaltd<?php echo $r['id'];?>"><?php echo $r['total']; ?></td>
											<input type="text"id ="total<?php echo $r['id'];?>" value ="<?php echo $r['total'];?>" hidden>
											<td class="center hidden-phone">
												<a href="#" class="btn btn-primary" id="edit" name = "<?php echo $r['id']; ?>">Add Stock</a>
										</tr>
										<?php $count++; } ?>
									</tbody>
								</table>
		...
		<script>
			...
			$("#editform").submit(function(e){
				...
				$.ajax({
					url: "menu-addstock-ajax.php?id="+id+"&stock="+stocks,
					method: "GET",
