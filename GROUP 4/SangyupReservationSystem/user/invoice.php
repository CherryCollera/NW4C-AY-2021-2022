		...
		<section class="body">
			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
					...
					$sql5 = "SELECT * FROM `booking_details` where booking_id = '$booking_number';";
					$result5 = $con->query($sql5);
					foreach ($result5 as $r5) {
					$status = $r5['status'];
					?>
					<?php if($status == 2){?>
					<a href="print_data.php?booking-number=<?php echo $_GET['booking-number']; ?>" class="btn btn-primary">Print</a>
					<?php } else {
						...
						<div class="panel-body">
							<div class="invoice">
								...
								<?php 
								 ...
								 $tempDir = "includes/temp/";
								 $booking_number = $_GET['booking-number'];
								 $codeContents = $booking_number;
								...
								<div class="bill-info">
									<div class="row">
										...
										<div class="bill-to">
											...
											<?php  }else{ ?>
												<span class="text-dark">Pick-Up</span>
												<?php  } ?>
											</div>
										</div>
									</div>
