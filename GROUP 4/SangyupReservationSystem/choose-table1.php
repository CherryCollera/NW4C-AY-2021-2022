                ...
                <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                  <div class="row">
                      ...
                      $con = connect();
                         ...
                         $b_id = $_GET['booking_number'];
                         $sql8 = "SELECT * FROM `booking_details` WHERE booking_id = '$b_id';";
                        $result8 = $con->query($sql8);
                        foreach ($result8 as $r8) {
                            $res_id = $r8['res_id'];
                            $reservation_date = $r8['booking_date'];
                            $reservation_time = $r8['booking_time'];
                      ...
                      <div class="col-lg-3" style="min-height: 190px">
                        ...
                        <nav class="menu2">
                          <input type="checkbox" id="restTable<?php echo $table_id; ?>" name="table[]" value="<?php echo $table_id; ?>" class="menu-toggler2 restTable"  data-id="<?php echo $table_id; ?>" checked disabled>
                          ...
                          <ul>
                            ...
                            <li class="menu-item2">
                              <input type="checkbox"  disabled="" checked>
                                ...
                                <?php } else{ ?>
                            <li class="menu-item2">
                              <input type="checkbox" name="chair[]" id="chair" value="<?php echo $r2['id']; ?>" style="display:none">
                            </li>
                                <?php } ?>
                            <?php } ?>
                          </ul>
                      ...
                      <div class="col-lg-12" style="margin-top: 15%;text-align: center;">
                        <div class="form-group">
                          ...
                          <input type="submit" value="Continue" name="selectChair" class="btn btn-primary py-3 px-5" >
                        </p>
                        </div>
                      </div>
                </div><!-- END -->
