        ...
        <div class="container">
          <div class="row slider-text align-items-center justify-content-center">
            <div class="col-md-10 col-sm-12 ftco-animate text-center"  >
              ...
              <h1 class="mb-3">Make an Order</h1>
            </div>
          </div>
        </div>
      </div>
                ...
                <div class="fields d-block d-lg-flex">
                  ...
                  <div class="select-wrap one-half">
                    ...
                    <select name="city" id="" class="form-control" disabled="">
                      <option value="India">Bataan</option>
                    </select>
                  </div>
      ...
      <div class="container">
        <div class="row no-gutters justify-content-center mb-5 pb-5">
          <div class="col-md-7 text-center heading-section ftco-animate">
            <h2>Choose a Pick-up Date and Time</h2>
          </div>
        </div>
        <div class="row d-flex">
          ...
          <div class="col-md-8 ftco-animate makereservation p-5 bg-light">
            ...
            <form action="select-menud.php" method="POST">
              <div class="row">
                <div class="col-md-6">
                ...
                <div class="col-md-12 mt-3">
                  <div class="form-group">
                    ...
                    <input type="submit" name="cod" value="Submit" class="btn btn-primary py-3 px-5">
                  </div>
                </div>
              </div>
            </form>
